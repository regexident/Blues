//
//  CentralManagerRestoreStateTestCase.swift
//  BluesTests
//
...
class CentralManagerRestoreStateTestCase: XCTestCase {
    ...
    func testRestoreationWithDictionary() {
        ...
        guard let scanOptions = CentralManagerScanningOptions(dictionary: CentralManagerScanningOptionsTestCase.dictionary) else {
            return XCTFail()
        }
    ...
    func testRestoreationWithInvalidDictionary() {
        var dictionary = CentralManagerRestoreStateTestCase.validInputDictionary()
    ...
    static func validInputDictionary(services: [UUID] = [], peripherals: [UUID] = []) -> [String: Any] {
        ...
        dictionary[CBCentralManagerRestoredStateScanOptionsKey] = CentralManagerScanningOptionsTestCase.dictionary
